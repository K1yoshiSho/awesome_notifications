        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            SimpleButton('Get next Monday after date', onPressed: () async {
              ...
              DateTime? nextValidDate = await AwesomeNotifications().getNextDate(schedule, fixedDate: referenceDate);

              late String response;
              if (nextValidDate == null) {
                response = 'There is no more valid date for this schedule';
              } else {
                response = AwesomeDateUtils.parseDateToString(nextValidDate.toUtc(), format: 'dd/MM/yyyy')!;
              }
            ...
            SimpleButton('Show media player', onPressed: () => Navigator.pushNamed(context, PAGE_MEDIA_DETAILS)),
            SimpleButton('Cancel notification',
                backgroundColor: Colors.red,
                labelColor: Colors.white,
