  ...
  Widget _buildMediaPlayer(BuildContext context) {
    ...
    return Theme(
        data: Theme.of(context).copyWith(
            ...
            colorScheme: contrastColor != null ? ColorScheme.light(primary: contrastColor!) : null,
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            IconButton(
              ...
              iconSize: maxSize * 0.05,
              onPressed: (durationPlayed == null || durationPlayed! < MediaPlayerCentral.replayTolerance) &&
                ...
                hasCloseCaption
                    ? IconButton(
                        ...
                        icon: Icon(Icons.closed_caption,
                            size: 48, color: closeCaptionActivated ? contrastColor : contrastColor?.withOpacity(0.5)),
                        onPressed: () => closeCaptionActivated = !closeCaptionActivated,
                      )
                    : SizedBox(height: 47),
                Text(printDuration(mediaLength), style: TextStyle(color: contrastColor)),
              ],
            ),
          ),
        ],
